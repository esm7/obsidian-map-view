...
export function getIconFromRules(tags: string[], rules: MarkerIconRule[], iconCache: IconCache) {
...
export class IconCache {
	...
	getIconIdAndCache(iconSpec: leaflet.ExtraMarkers.IconOptions) {
		const hashFunction = (s: string) => s.split('').reduce((a,b) => (((a << 5) - a) + b.charCodeAt(0))|0, 0);
