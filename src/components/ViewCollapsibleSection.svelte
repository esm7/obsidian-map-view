<script lang="ts">
	...
	let { headerText, children, expanded, afterToggle }:
		{ headerText: string, children?: Snippet, expanded: boolean, afterToggle?: (expanded: boolean) => void} = $props();
