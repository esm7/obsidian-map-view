<script lang="ts">
    ...
    async function purge() {
        ...
        if (purged > 0) {
            ...
            new Notice(
                `No tiles older than ${maxAgeMonths} months found in this layer.`,
            );
        close();
    }
</script>
...
<div class="purge-tiles">
    <div class="setting-item">
        <div class="setting-item-info">
            ...
            <div class="setting-item-description">
                ...
                <p>
                    There is currently no way to differentiate between tiles
                    downloaded explicitly via the dialog or automatic cache.
                </p>
            </div>
        </div>
    </div>
    <div class="setting-item">
        <div class="setting-item-info">
            <div class="setting-item-name">Delete older than...</div>
        </div>
    ...
    <div class="setting-item modal-button-container">
        ...
        <button class="mod-warning" onclick={purge}> Purge </button>
    </div>
</div>
